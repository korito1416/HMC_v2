...
def load_site_data(site_num,
    ...
    gammamean          = df[f'new_gamma_{n}Sites'].to_numpy()
    thetamean          = df[f'new_theta_{n}Sites'].to_numpy()
    newgammasd         = df[f'newgammaSD_{n}Sites'].to_numpy()
    newthetasd         = df[f'newthetaSD_{n}Sites'].to_numpy()
    try:
